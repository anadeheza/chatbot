...
const RECIPES = [
  {
    ...
    difficulty: "Medium",
    image:
      "https://plus.unsplash.com/premium_photo-1695240028448-9a8bf3e164f5?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8cmlzb3R0b3xlbnwwfHwwfHx8MA%3D%3D",
  ...
  },
  {
    ...
    difficulty: "Medium",
    image:
      "https://images.unsplash.com/photo-1632229095740-8c75082087c5?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bGFzYSVDMyVCMWElMjBkZSUyMGJlcmVuamVuYXxlbnwwfHwwfHx8MA%3D%3D",
  ...
  },
  {
    ...
    difficulty: "Hard",
    image:
      "https://images.unsplash.com/photo-1597604391235-a7429b4b350c?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8c291cmRvdWdoJTIwYnJlYWR8ZW58MHx8MHx8fDA%3D",
  ...
  },
  {
    ...
    difficulty: "Medium",
    image:
      "https://images.unsplash.com/photo-1607958996333-41aef7caefaa?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bXVmZmluJTIwYXIlQzMlQTFuZGFub3xlbnwwfHwwfHx8MA%3D%3D",
  ...
  },
  {
    ...
    difficulty: "Easy",
    image:
      "https://images.unsplash.com/photo-1634213672726-ce9c6acb91c2?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fFNoYWtzaHVrYXxlbnwwfHwwfHx8MA%3D%3D",
  ...
  },
  {
    ...
    difficulty: "Easy",
    image:
      "https://images.unsplash.com/photo-1563612116625-3012372fccce?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHN1c2hpfGVufDB8fDB8fHww",
      ...
      <section id="recipes" className="recipes-section">
        <div className="recipes-header">
          ...
          <p className="section-sub">
            Not sure where to start? Browse for a recipe that catches your eye!
          </p>
        </div>
            ...
            >
              ...
              <div className="recipe-body">
                ...
                <div className="recipe-footer">
                  <span
                    className={`recipe-diff diff-${r.difficulty.toLowerCase()}`}
                  >
                    {r.difficulty}
                  </span>
                  <button
            ...
            <div className="recipe-modal-img-wrap">
              ...
              <div className="recipe-modal-title-block">
                <span
                  ...
                  style={{ "--card-accent": selectedRecipe.color }}
                >
                  {selectedRecipe.tag}
                </span>
                ...
                <div className="recipe-modal-meta">
                  ...
                  <span
                    className={`recipe-diff diff-${selectedRecipe.difficulty.toLowerCase()}`}
                  >
              ...
              <ol className="recipe-steps-list">
                {selectedRecipe.steps.map((step, i) => (
                  <li key={i} className="recipe-step-item">
                    <span
                      className="recipe-step-num"
                      style={{ background: selectedRecipe.color }}
                    >
                      {i + 1}
                    </span>
